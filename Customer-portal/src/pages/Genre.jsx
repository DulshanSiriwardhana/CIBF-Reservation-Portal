...
const Genres = () => {
  ...
  useEffect(() => {
    ...
    if (user != null) {
      const fetchUserGenres = async () => {
        const userGenres = await genreService.getGenresById(user.userId);
  ...
  useEffect(() => {
    const fetchGenres = async () => {
      const listGenres = await genreService.getGenres();
  ...
  return (
    <div className="min-h-screen bg-gray-50 py-12 px-4">
      {
        user == null ? (
        <div className="max-w-3xl mx-auto mt-20 text-center p-10 bg-gray-50 rounded-2xl border border-gray-200">
          <div className="flex justify-center mb-4">
            <svg className="w-16 h-16 text-gray-700" fill="none" stroke="currentColor" strokeWidth="1.5" viewBox="0 0 24 24">
              <path strokeLinecap="round" strokeLinejoin="round" d="M15.75 9V5.25A2.25 2.25 0 0013.5 3h-3A2.25 2.25 0 008.25 5.25V9m9 0H6m12 0v9A2.25 2.25 0 0115.75 20.25H8.25A2.25 2.25 0 016 18V9m12 0H6" />
            </svg>
          </div>
          ...
          <p className="text-gray-600 text-lg">
            Please log in to access your Genre Selection page.
          </p>
        </div>
